...
const perguntas = [
    {
        texto: "Eu vou _________ para a praia",
        respostaCorreta: "VIAJAR",
        opcoes: ["VIAJAR", "COMER", "LEGAL", "NÓS"]
    },
    {
        texto: "Nós temos que _________ esportes",
        respostaCorreta: "PRATICAR",
        opcoes: ["PRATICAR", "CIDADE", "COMER", "NÓS"]
    },
    {
        texto: "Eu vou _________ pizza no meu aniversário",
        respostaCorreta: "COMER",
        opcoes: ["COMER", "CORRER", "ANDAR", "NÓS"]
    },
    {
        texto: "Ela _________ salada todos os dias",
        respostaCorreta: "COME",
        opcoes: ["COME", "LINDA", "ELAS", "LEGAL"]
    },
    {
        texto: "Amanhã eu vou _________",
        respostaCorreta: "TRABALHAR",
        opcoes: ["TRABALHAR", "CIDADE", "NÓS", "ELAS"]
    }
];
